...
class Board:
    ...
    def current_player(self):
        ...
        if (self.__array == utilities.initial_state(self.__rows, self.__columns)).all():
            return self.__first_player
    ...
    def result(self, action: Action):
        ...
        new_board = Board(self.__first_player, self.__rows, self.__columns, self)

        # set the actions and return the new board.
        new_board.set(action.get_x(), action.get_y())
